...
2003-08-04 ROwen    Added addCallback; modified to use opscore.RO.AddCallback.
...
class Button(tkinter.Button, opscore.RO.AddCallback.TkButtonMixin, CtxMenuMixin, SeverityActiveMixin):
    def __init__(self,
        master,
        helpText = None,
        helpURL = None,
    ...
    **kwArgs):
        ...
        if opscore.RO.TkUtil.getWindowingSystem() == opscore.RO.TkUtil.WSysAqua:
        ...
        opscore.RO.AddCallback.TkButtonMixin.__init__(self,
            callFunc = callFunc,
            callNow = False,
            command = command,
        )
