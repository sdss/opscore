...
class CmdVar(object):
    ...
    def __init__(self,
        ...
        self.keyVarTimestampDict = dict()  # Similar to keyVarDataDict but stores the timestamp.
        for keyVar in self.keyVars:
            self.keyVarDataDict[keyVar] = []
            self.keyVarTimestampDict[keyVar] = []
    ...
    def getKeyVarTimestamps(self, keyVar):
        """Return a list with the timestamps associated with a keyVar.

        Supplies the timestamps for the data returned by `.getKeyVarData`.
        ...
        return self.keyVarTimestampDict[keyVar]
    ...
    def _keyVarCallback(self, keyVar):
        ...
        self.keyVarTimestampDict[keyVar].append(keyVar.timestamp)
