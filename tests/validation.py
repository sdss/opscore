...
class ValidationTest(unittest.TestCase):
    ...
    def test02(self):
        ...
        self.assertEqual(
            self.c123, self.cmd1.create('key1', ('key2', '-1.2'), ('key3', ['0xdead', '0xbeef'])))
        self.assertEqual(
            self.c321, self.cmd1.create(('key3', '0xdead', '0xbeef'), ('key2', ['-1.2']), 'key1'))
    ...
    def test03(self):
        ...
        self.assertRaises(
            KeysError, lambda: self.cmd1.create('key1', ('key2', 'abc'),
                                                ('key3', ['0xdead', '0xbeef'])))
        self.assertRaises(
            KeysError, lambda: self.cmd1.create('key1', ('key2', '1.2'),
                                                ('key3', ['1.2', '0xbeef'])))
        self.assertRaises(
            KeysError, lambda: self.cmd1.create('key1', ('key2', '1.2', '2.3'),
                                                ('key3', ['0xdead', '0xbeef'])))
    ...
    def test04(self):
        ...
        self.assertRaises(
            ValidationError, lambda: self.cmd1.create(('key2', '1.2'),
                                                      ('key3', ['0xdead', '0xbeef'])))
        self.assertRaises(
            ValidationError, lambda: self.cmd1.create('key4', ('key2', '1.2'),
                                                      ('key3', ['0xdead', '0xbeef'])))
        self.assertRaises(
            ValidationError, lambda: self.cmd1.create('key1', ('key2', '1.2'),
                                                      ('key3', ['0xdead', '0xbeef']),
                                                      values=[1.2, 2.3]))
