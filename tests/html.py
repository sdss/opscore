...
class HTMLTests(unittest.TestCase):
    ...
    def test01_HTML(self):
        ...
        doc = utilHtml.HTMLDocument(utilHtml.Head(),
                                    utilHtml.Body(utilHtml.Div('This is the', id='appendme')))
    ...
    def test03_HTML(self):
        ...
        d = utilHtml.Div('This is text within a', utilHtml.Span('red', className='red'),
                         'div element')
