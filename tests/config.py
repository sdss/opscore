...
class ConfigTest(unittest.TestCase):
    ...
    def test09(self):
        "Invalid bool option"
        self.assertRaises(
            ValueError, lambda: self.cli.add_option("--badBoolOpt", action="store_true")
        )
    ...
    def test10(self):
        ...
        (options, args) = self.cli.parse_args(
            args=[], passphrase="The quick brown fox jumps over the lazy dog"
        )
